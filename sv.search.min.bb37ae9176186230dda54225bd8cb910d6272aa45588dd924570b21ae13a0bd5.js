...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/sv.search-data.min.c6fe35c056be70986bd59a401d1b9d7acdc9646fac47d1a7875135c226a29537.js',function(){input.required=false;search();});}
