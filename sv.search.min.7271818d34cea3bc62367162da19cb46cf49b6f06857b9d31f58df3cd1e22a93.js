...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/sv.search-data.min.410cc980a265ce657a243736328e76aedbc24ed224bab024d59682db68598021.js',function(){input.required=false;search();});}
